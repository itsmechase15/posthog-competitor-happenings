...
/**
 * Sitemap discovery only yields a URL, so a blog item reaches analysis with
 * nothing but its slug. Fetch the article itself for the handful of items that
 * are actually new, and use its real title and body.
 */
