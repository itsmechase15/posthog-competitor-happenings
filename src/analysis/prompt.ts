...
- "key_points" is 2 to 4 short lines of substance that go under a "What you need to KNOW" heading: what it does, who it is for, what it replaces, what is still missing. Fragments, not paragraphs — under 140 characters each. No line repeats the summary.
- "impact" is a label only. low = cosmetic or incremental. medium = real capability PostHog customers will ask about. high = strategic move that changes the comparison.
...
- Do not invent product facts about PostHog or the competitor. If the source text is thin, say so in the summary and keep impact low.`;
...
Content:
${body || "(no body text available — reason from the title and URL, and keep impact low)"}
