...
Every update_pages action ships the rewrite with it, in "proposed_text" on the ref for the page it fixes. This is not optional and the action is dropped without it:
